...
<!-- this is a test file that overrides all the colors with fuscia -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
    ...
    <xsl:attribute-set name="cover.border.left" use-attribute-sets="base.pre.style">
        ...
        <xsl:attribute name="border-left-color">#FF00FF</xsl:attribute>
    </xsl:attribute-set>
    <xsl:attribute-set name="cover.border.left.bottom" use-attribute-sets="cover.border.left">
        ...
        <xsl:attribute name="border-bottom-color">#FF00FF</xsl:attribute>
    </xsl:attribute-set>
    ...
    <xsl:attribute-set name="table.subheading.cell" use-attribute-sets="base.cell">
        ...
        <xsl:attribute name="border-before-color">#FF00FF</xsl:attribute>
        <xsl:attribute name="display-align">after</xsl:attribute>
    </xsl:attribute-set>
